...
class BookMedicalCenters extends StatefulWidget {
  String name;
  dynamic description;
  String img;
  String phone;
  ...
  @override
  State<BookMedicalCenters> createState() => _BookMedicalCenters();
}

class _BookMedicalCenters extends State<BookMedicalCenters> {
  void book({
    ...
    String url =
        'http://eibtek2-001-site3.atempurl.com/api/Centersappoint/${widget.id}';
    final dio = Dio();
    Response response;
