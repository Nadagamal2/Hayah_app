...
class BookAnalysisLapCenters extends StatefulWidget {
  String name;
  dynamic description;
  String img;
  String phone;
  ...
  @override
  State<BookAnalysisLapCenters> createState() => _BookAnalysisLapCenters();
}

class _BookAnalysisLapCenters extends State<BookAnalysisLapCenters> {
  ...
  void book({
    ...
    String url =
        'http://eibtek2-001-site3.atempurl.com/api/Lapappoint/${widget.id}';
    final dio = Dio();
    Response response;
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          ...
          //         title: Text("Take a Rate".tr()),
          //         content: Column(
          //           crossAxisAlignment: CrossAxisAlignment.center,
          //           mainAxisSize: MainAxisSize.min,
          //           children: [
          //             Text(
          //               "Please leave a star rating".tr(),
          //               style: TextStyle(
          //                 fontSize: 18,
          //               ),
          //             ),
