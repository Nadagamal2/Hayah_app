...
class BookHospitalCenters extends StatefulWidget {
  String name;
  dynamic description;
  String img;
  int id;
  ...
  @override
  State<BookHospitalCenters> createState() => _BookHospitalCenterss();
}

class _BookHospitalCenterss extends State<BookHospitalCenters> {
  BookDoctorScreen() {
  ...
  void book({
    ...
    String url =
        'http://eibtek2-001-site3.atempurl.com/api/Hospitalappoint/${widget.id}';
    final dio = Dio();
    Response response;
  ...
  final userName2Controller = new TextEditingController();
  final PhoneNumber2Controller = new TextEditingController();
  final Age2Controller = new TextEditingController();
  final Code2Controller = new TextEditingController();
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      book(
                          userName: '${userName2Controller.text.toString()}',
                          phone: '${PhoneNumber2Controller.text.toString()}',
                          age: Age2Controller.text.toString(),
                          code: '${Code2Controller.text.toString()}',
                          gender: '${_selectvalue}',  AppointDate:
