...
class BookXRayCenters extends StatefulWidget {
  String name;
  dynamic description;
  String img;
  String phone;
  ...
  @override
  State<BookXRayCenters> createState() => _BookXRayCenters();
}

class _BookXRayCenters extends State<BookXRayCenters> {
  void book({
    ...
    String url =
        'http://eibtek2-001-site3.atempurl.com/api/XRaysappoint/${widget.id}';
    final dio = Dio();
    Response response;
